...
def save_month_csv(month_start, month_end, month_period, **context):
    ...
    file_name = f'tolstyakoff_{month_period}.csv'
    s3_client.put_object(
...
def save_to_pg(data, month_start, month_end, month_period):
    ...
    with pg.connect(
        ...
        cursor.execute('''
            DELETE FROM tolstyakoff_les10_monthly_raw
        ...
        for record in data:
            ...
            cursor.execute("""
                           INSERT INTO tolstyakoff_les10_monthly_raw
...
with DAG(
    dag_id='tolstyakoff_les_10_jinja',
    tags=['tolstyakoff'],
    schedule='@daily',
