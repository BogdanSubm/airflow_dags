...
def load_from_api(**context):
    ...
    with pg.connect(
        ...
        for el in data: # Проходим по всем элементам словаря
            ...
            cursor.execute("INSERT INTO admin_table VALUES (%s, %s, %s, %s, %s, %s, %s)", row) # Выполняем запрос
...
# Создание DAG
with DAG(
    dag_id="max_khalilov_dag179", 
    tags=['1', 'maxim'], # Теги. По ним можно так же находить DAG
